...
<head>
  ...
  <meta http-equiv="x-ua-compatible" content="ie=edge"><title>Andon System</title>
...
<style>
div::-webkit-scrollbar{width:10px}div::-webkit-scrollbar-track{border-radius:10px;box-shadow:inset 0 0 6px rgba(0,0,0,.3)}div::-webkit-scrollbar-thumb{background-color:#267ae0;border-radius:10px}@media only screen and (max-width:600px){.request_form{font-size:10px}}
body{
  font-family:arial;
}
button{
                ...
                <div class="card col-12 pt-3 pb-3">
                    ...
                    <div class="row">
                        <div class="col-12 text-center mt-2 mb-3">
                          <input type="password" id="scanId"  class="z-depth-1 form-control text-center" disabled placeholder="Scan your ID" autocomplete="off" disabled>
                        </div>
                    </div>
<!-- --------------------------------------------------------------------------------------------------------------------------------- -->
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            ...
                            <button id="btnSubmit" class="btn red z-depth-5 white-text btn-sm" disabled style="border-radius:20px;">Submit</button>
                            <button class="btn green z-depth-5 white-text btn-sm" onclick="location.reload()" style="border-radius:20px;">Cancel</button>
                        </div>
                    </div>
                     <br>
                    <center>
...
<!-- VIEWER LOCATION ----------------------------------------------------------------------------------------------------------->
        <div class="col-8 mt-2">
            <div class="row">
                <select class="browser-default custom-select z-depth-5" id="viewerFilter" onchange="requestView()" style="width:auto;margin-bottom:-3%;margin-left:1%;">
                ...
                <!-- PRODUCTION -->
                <select class="browser-default custom-select z-depth-5" id="requestProd" onchange="requestView()" style="width:auto;margin-bottom:-3%;margin-left:1%;">
            ...
            <br>
            <div class="row">
                <select class="browser-default custom-select z-depth-5" id="viewerFilterOngoing" onchange="ongoingView()" style="width:auto;margin-bottom:-3%;margin-left:1%;">
                    <option value="">--All Department--</option>
                     <?php
                        $sql = "SELECT *FROM tbldepartment";
                        $query = $db->query($sql);
                ...
                <!-- PRODUCTION -->
                <select class="browser-default custom-select z-depth-5" id="ongoingProd" onchange="ongoingView()" style="width:auto;margin-bottom:-3%;margin-left:1%;">
                    <option value="">--All Production--</option>
                    <option value="initial">Initial</option>
                    <option value="final">Final</option>
                </select>
...
<!-- ------------------------------------------------------------------------------------------------------------------------------ -->
  <script type="text/javascript" src="js/jquery-3.4.1.min.js"></script> <script type="text/javascript" src="js/popper.min.js"></script> <script type="text/javascript" src="js/bootstrap.min.js"></script> <script type="text/javascript" src="js/mdb.min.js"></script> <script type="text/javascript" src="sweetalert/sweetalert2.all.min.js"></script> <script type="text/javascript" src="sweetalert/sweetalert2.all.js"></script> <script src="js/selectize.js"></script>
 <script>
