...
if (isset($_GET['listId'])) {
    ...
    <div class="row">
        <div class="col-sm-6">
            <table class="left">
                ...
                <tr>
                    ...
                    <td id="machineNameTD" class="text-left" style="font-size:12px;font-weight: bold;">
                        <?= $machineName; ?>
                    </td>
                </tr>
                <tr>
        ...
        <div class="col-sm-6">
            <div>
                <button class="btn blue text-center btn-sm white-text z-depth-5" id="confirmationBTN" data-toggle="modal"
                    data-target="#confirmationModal">Change Information</button>
                <br>
    ...
    <!-- GRAPH ---------------------------------------------------------------------------------------------------------------->
        ...
        <div class="col-sm-6">
            ...
            <fieldset>
                ...
                if ($department == "EQD" && $machineName == "TRD" && $trd_concern == 'Applicator') {
                    ?>
                    <center style="font-size:12px;font-weight:bold;">TRD APPLICATOR SOLUTION INTENDED ONLY FOR CRIMPING AND
                        ANVIL</center>
                    <div class="form-group col-sm-12">
                        <select class=" custom-select browser-default mt-1 z-depth-1" id="solutionTRD" onchange="enable_part()"
                        ...
                        <select class=" custom-select browser-default mt-1 z-depth-1 " id="replaceStat" disabled=""
                            style="font-size:12px;">
                            <option value="" disabled="" selected="" onclick="enable_appl_name()">--Parts Used--</option>
                            <option value="local">Local</option>
                            <option value="imported">Imported</option>
                        </select>
                        <input type="text" class="form-control mt-1 z-depth-1" id="app_name" name=""
                            placeholder="Applicator Name" style="font-size:12px;" autocomplete="off" disabled="">
                        <input type="text" class="form-control mt-1 z-depth-1" id="app_uniq_num" name=""
                            placeholder="Applicator Unique #" style="font-size:12px;" autocomplete="off" disabled="">
                        <input type="text" class="form-control mt-1 z-depth-1" id="app_work_order_no" name=""
                            placeholder="Work Order #" style="font-size:12px;" autocomplete="off" disabled="">
                        <input type="password" class="form-control mt-2 z-depth-1" id="jr_staff_verification" name=""
                            placeholder="Jr. Staff Verification ID" style="font-size:12px;border:1px solid green;"
                            autocomplete="off" onchange="verify_operator(<?= $listId; ?>)" disabled>
