...
if (isset($_POST['listId'])) {
    ...
    <input type="password" class="form-control" name="scanId" id="cancelScanID" placeholder="SCAN STAFF/JR. STAFF ID"
        autocomplete="off">
    <input type="text" class="form-control mt-2" name="reason" id="reason" placeholder="REASON" required autocomplete="off"
        disabled>
    <?php
}
?>
