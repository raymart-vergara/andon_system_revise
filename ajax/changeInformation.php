...
if (isset($_POST['listIDforChange'])) {
  ...
  <table class="col-12" style="padding:10px;" cellpadding="10px">
    <tr>
      <td>Machine Name:</td>
      <td>
        <select class="machineName custom-select browser-default z-depth-3" id="machineName_update" style="width:100%;"
          onchange="detect_process()">
          <option value="<?= $machineName; ?>" style="font-weight:bold;">
            <?= $machineName; ?>
          </option>
          <?php
    ...
    <tr>
      ...
      <td>
        <select class="custom-select browser-default z-depth-3" id="process_change" style="width:100%;">
          <option value="<?= $process; ?>" style="font-weight:bold;">
            <?= $process; ?>
          </option>
          <?php
    ...
    <tr>
      ...
      <td>
        <select class="custom-select browser-default z-depth-3" id="machine_num_change" style="width:100%;">
          <option value="<?= $machineNo; ?>" style="font-weight:bold;">
            <?= $machineNo; ?>
          </option>
          <?php
