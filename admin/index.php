...
<body>
	...
	<div class="row">
		...
		<div class="col l6 m6 s12">
			<center>
				<img src="Img/technician.svg" class="responsive-img" style="width:50%;">
			</center>
		</div>
			...
			<div class="row">
				...
				<form action="" method="POST" style="display: none;">
					...
					<div class="row input-field col s12">
						<input type="password" name="passcode" ><label>ACCESS CODE</label>
					</div>
					<!-- submit -->
					<div class="row input-field col s12">
						<input type="submit" class="btn blue col s3 z-depth-5" name="loginBtn"  style="border-radius:10px;" value="Login">
					</div>
				</form>
			</div>
		</div>
